...
public abstract class AbstractRecommenderEvaluator implements RecommenderEvaluator {
  ...
  protected static final Logger log = LoggerFactory.getLogger(AbstractRecommenderEvaluator.class);

  private final Random random;
  private float maxPreference;
  private float minPreference;

  protected AbstractRecommenderEvaluator() {
  ...
  protected abstract void evaluateOneUser(Recommender recommender,
                                          long testUserID,
  ...
  public final class PreferenceEstimateCallable implements Callable<Void> {
    ...
    protected final AtomicInteger noEstimateCounter;
